...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Lấy nút "Edit" trong modal
    const submitEditButton = document.getElementById('submit-edit-emp');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Lấy nút "Edit" trong modal
    const submitEditButton = document.getElementById('submit-edit-user');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Lấy nút "Edit" trong modal
    const submitEditButton = document.getElementById('submit-edit-category');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Lấy nút "Edit" trong modal
    const submitEditButton = document.getElementById('submit-edit-coupon');
...
//     // Lấy nút "Edit" trong modal
//     const submitEditButton = document.getElementById('submit-edit-product-coupon');
...
// document.addEventListener('DOMContentLoaded', function () {
//     // Lấy tất cả các toast
//     var toastElList = [].slice.call(document.querySelectorAll('.toast'))
//     var toastList = toastElList.map(function (toastEl) {
//       return new bootstrap.Toast(toastEl, {
//         autohide: false // Không tự động ẩn toast
//       })
//     })
